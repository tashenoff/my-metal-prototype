...
import { MapPinIcon, ArrowRightIcon, StarIcon } from '@heroicons/react/24/outline'; // Импортируем иконки

const AdCard = ({ id, metalType, quantity, price, location, publishedDate, isFavorite, toggleFavorite }) => {
  return (
